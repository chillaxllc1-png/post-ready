        ...
        <main className="mx-auto w-full max-w-xl px-5 py-10">
            ...
            <section className="space-y-6 text-sm leading-relaxed text-zinc-800">
                ...
                <div className="space-y-2">
                    ...
                    <p>
                        本サービスでは、アカウント登録時にメールアドレスおよび
                        認証情報（パスワード等）を取得します。
                        これらの情報は、アカウント管理および本人確認の目的にのみ使用されます。
                    </p>

                    <p>
                        また、ポイント購入時の決済処理は、
                        外部の決済サービス（PAY.JP）を利用して行われます。
                        本サービスが、クレジットカード番号等の決済情報を直接保存・管理することはありません。
                    </p>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <p>
                        本サービスの運用および改善のため、
                        アクセス解析やログ収集、決済処理等の外部サービスを利用する場合があります。
                    </p>
                </div>
